...
productRoutes.post("/create", (0, authorization_middleware_1.default)(client_1.UserRole.admin), (0, fileUpload_middleware_1.default)("thumbnail", "product", [
    "image/jpeg",
    "image/jpg",
    "image/png",
...
productRoutes.patch("/update/:id", (0, authorization_middleware_1.default)(client_1.UserRole.admin), (0, fileUpload_middleware_1.default)("thumbnail", "product", [
    "image/jpeg",
    "image/jpg",
    "image/png",
