...
campaignRoutes.post("/create", (0, authorization_middleware_1.default)(client_1.UserRole.admin), (0, fileUpload_middleware_1.default)("banner", "campaign", ["image/jpeg", "image/jpg", "image/png"]), campaign_controller_1.default.createCampaign);
